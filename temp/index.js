...
const config = {
    A187: ' BOT TIO DARK ',
    instagram: ' OFF AF ',
    nomer: 'wa.me/18255255120,
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UC5daFS8tcu_t-5kqUNSgPRg',
    whatsapp: 'https://chat.whatsapp.com/FGMZ8HWZpko6O2WL1FV4Rn',
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[❗] Seu chupão do dark, Envie um vídeo com a legenda *! StickerGif ', id)
                )
            }
            break     
     case 'sticker':
